function[p] = param_ORI01(p)

% Parameters for processing original images of test cases 
%
   ...
   %                p.thresh_im2 is for a hard value
    p.thresh_im = [];
    p.thresh_im2= 50; %34000; YM: to be replaced by the main program
                               
                               
%parameters for finding xlinks
    p.thresh_Dxlink = 1.5; %dist fun. threshold for a point to be considered an x-link
    p.s_xlinkbox    = 10; %5; %radius of box in which to check to make sure xlink is a local max of the distance function
