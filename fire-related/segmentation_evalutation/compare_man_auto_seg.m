...
precision = zeros(num_images,num_methods,num_params,num_crops);
recall = zeros(num_images,num_methods,num_params,num_crops);
fmeas = zeros(num_images,num_methods,num_params,num_crops);
true_pos_rt = zeros(num_images,num_methods,num_params,num_crops);
false_pos_rt = zeros(num_images,num_methods,num_params,num_crops);
