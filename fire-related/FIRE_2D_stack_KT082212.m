% FIRE_2D_stack_KT082212.m
% 08182012: Process image stack provided by Karissa
...
iNF  = 1:4;        %  test case(s) to be analyzed
% iSNF = [1];    %  slice(s) to process    
FIREori = 0 ;     % FIREori = 1: run FIRE on original image
...
% IS is the image of a slice
    ...
    iSNF = 1:num_images;  % slices to be processed
