%% plot_angle_results
% run after FIRE_2D_0508_Bbat2.m
...
iNF = 1:15;%[11:15];  % iN numbers in Fire
...
% case1: show angle_xy of fibers with their length are larger than a
...
hist(angEALL*180/pi,bin)
axis square
title('Extracted Angle-XY Hist - Each fiber') 
xlabel('Angle(degree)','fontsize',12)
ylabel('Frequency','fontsize',12)

figure(9);clf
[NExy0 NNExy0] = histnorm2(angEALL*180/pi,edges,1,1);
...
[Nxy0 NNxy0] = histnor1(angALL*180/pi,edges);
...
%  save(FIREangS,'fmat','NExy0','NNExy0','angEALL','NxyI', 'NNxyI','angALL','Nxy0', 'NNxy0','angIALL')
